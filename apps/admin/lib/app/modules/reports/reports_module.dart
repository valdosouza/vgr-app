...
/// `/reports` list, `/reports/:id` detail; both behind the admin session.
/// The grant (`reports` VIEW) is enforced per route by the API (72) — the
/// menu simply does not show the screen without it (71).
